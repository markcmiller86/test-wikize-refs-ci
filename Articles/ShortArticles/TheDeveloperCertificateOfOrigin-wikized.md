...
[sl]: #sfer-ezikiw-sl "An Introduction to Software Licensing"
[ca]: #sfer-ezikiw-ca "Contributor Agreements"
[cla]: #sfer-ezikiw-cla "Contributor License Agreement"
[gitlab-dco]: #sfer-ezikiw-gitlab-dco "GitLab: We're switching to a DCO for source code contributions"
[gitlab-dco-just]: #sfer-ezikiw-gitlab-dco-just "GitLab: MEMO CLA vs DCO + License"
[gitlab-dco-benefits]: #sfer-ezikiw-gitlab-dco-benefits "The power of open source: Why GitLab’s move to a Developer Certificate of Origin benefits the developer community"
[cla-vs-dco]: #sfer-ezikiw-cla-vs-dco "CLA vs. DCO: What's the difference?"
[dco]: #sfer-ezikiw-dco "Developer Certificate of Origin"
[linux-kernel-github]: #sfer-ezikiw-linux-kernel-github "Linux Kernel Git Repository"
[ciibp]: #sfer-ezikiw-ciibp "CII Best Practices"
[ciibp-dco]: #sfer-ezikiw-ciibp-dco "CII Best Practices [dco]"
[git-gpg]: #sfer-ezikiw-git-gpg "Git Tools - Signing Your Work"
[dco-vs-clas]: #sfer-ezikiw-dco-vs-clas "Developer Certificate of Origin versus Contributor License Agreements"
[github-dco]: #sfer-ezikiw-github-dco "Github DCO App"
[github-contrib-ass]: #sfer-ezikiw-github-contrib-ass "Handling CLAs and DCOs via GitHub Action"
<!-- (sfer-ezikiw begin) -->
### References
<!-- (sfer-ezikiw end) -->
* <a name="sfer-ezikiw-ca"></a><sup>ca</sup>[Contributor Agreements](https://contributoragreements.org/)
* <a name="sfer-ezikiw-ciibp"></a><sup>ciibp</sup>[CII Best Practices](https://bestpractices.coreinfrastructure.org/en/criteria)
* <a name="sfer-ezikiw-ciibp-dco"></a><sup>ciibp-dco</sup>[CII Best Practices [dco]](https://bestpractices.coreinfrastructure.org/en/criteria?details=true&rationale=true#1.dco)
* <a name="sfer-ezikiw-cla"></a><sup>cla</sup>[Contributor License Agreement](https://en.wikipedia.org/wiki/Contributor_License_Agreement:)
* <a name="sfer-ezikiw-cla-vs-dco"></a><sup>cla-vs-dco</sup>[CLA vs. DCO: What's the difference?](https://opensource.com/article/18/3/cla-vs-dco-whats-difference)
* <a name="sfer-ezikiw-dco"></a><sup>dco</sup>[Developer Certificate of Origin](https://developercertificate.org/)
* <a name="sfer-ezikiw-dco-vs-clas"></a><sup>dco-vs-clas</sup>[Developer Certificate of Origin versus Contributor License Agreements](https://jponge.medium.com/developer-certificate-of-origin-versus-contributor-license-agreements-339f36567dd7)
* <a name="sfer-ezikiw-git-gpg"></a><sup>git-gpg</sup>[Git Tools - Signing Your Work](https://git-scm.com/book/en/v2/Git-Tools-Signing-Your-Work)
* <a name="sfer-ezikiw-github-contrib-ass"></a><sup>github-contrib-ass</sup>[Handling CLAs and DCOs via GitHub Action](https://github.com/contributor-assistant/github-action/blob/master/README.md)
* <a name="sfer-ezikiw-github-dco"></a><sup>github-dco</sup>[Github DCO App](https://github.com/apps/dco)
* <a name="sfer-ezikiw-gitlab-dco"></a><sup>gitlab-dco</sup>[GitLab: We're switching to a DCO for source code contributions](https://about.gitlab.com/blog/2017/11/01/gitlab-switches-to-dco-license/)
* <a name="sfer-ezikiw-gitlab-dco-benefits"></a><sup>gitlab-dco-benefits</sup>[The power of open source: Why GitLab’s move to a Developer Certificate of Origin benefits the developer community](https://sdtimes.com/certificate-of-origin/power-open-source-gitlabs-move-developer-certificate-origin-benefits-developer-community)
* <a name="sfer-ezikiw-gitlab-dco-just"></a><sup>gitlab-dco-just</sup>[GitLab: MEMO CLA vs DCO + License](https://docs.google.com/document/d/1zpjDzL7yhGBZz3_7jCjWLfRQ1Jryg1mlIVmG8y6B1_Q)
* <a name="sfer-ezikiw-linux-kernel-github"></a><sup>linux-kernel-github</sup>[Linux Kernel Git Repository](https://github.com/torvalds/linux/commits/master)
* <a name="sfer-ezikiw-sl"></a><sup>sl</sup>[An Introduction to Software Licensing](https://bssw.io/items/an-introduction-to-software-licensing)
